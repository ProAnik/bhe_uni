...
const Universities = () => {
    return (
        <div>
            <h2 className='font-kanit font-semibold text-[32px] leading-[46px] tracking-normal text-center text-[#1E285F]'>Trusted by 10,000+ Universities around the world</h2>
